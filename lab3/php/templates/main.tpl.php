            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link <?php if($module == 'insurance') { echo 'active'; } ?>" href="index.php?module=insurance&action=list">Draudimai</a></li>
                        <li class="nav-item"><a class="nav-link <?php if($module == 'guide') { echo 'active'; } ?>" href="index.php?module=guide&action=list">Gidai</a></li>
                        <li class="nav-item"><a class="nav-link <?php if($module == 'client') { echo 'active'; } ?>" href="index.php?module=client&action=list">Klientai</a></li>
                        <li class="nav-item"><a class="nav-link <?php if($module == 'order') { echo 'active'; } ?>" href="index.php?module=order&action=list">Rezervacijos</a></li>
                        <li class="nav-item"><a class="nav-link <?php if($module == 'report') { echo 'active'; } ?>" href="index.php?module=report&action=list">Ataskaita</a></li>
                    </ul>
                </div>
            </div>
        </nav>
